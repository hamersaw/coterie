...
pub struct JoinMsg {
    ...
    address: ::protobuf::SingularPtrField<SocketAddr>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::std::cell::Cell<u32>,
}
...
impl JoinMsg {
    ...
    // Param is passed by value, moved
    pub fn set_address(&mut self, v: SocketAddr) {
        self.address = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_address<'a>(&'a mut self) -> &'a mut SocketAddr {
    ...
    // Take field
    pub fn take_address(&mut self) -> SocketAddr {
        self.address.take().unwrap_or_else(|| SocketAddr::new())
    }

    pub fn get_address<'a>(&'a self) -> &'a SocketAddr {
        self.address.as_ref().unwrap_or_else(|| SocketAddr::default_instance())
    }
}
...
pub struct PeerTableDumpMsg_PeerTableEntry {
    ...
    value: ::protobuf::SingularPtrField<SocketAddr>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::std::cell::Cell<u32>,
}
...
impl PeerTableDumpMsg_PeerTableEntry {
    ...
    // Param is passed by value, moved
    pub fn set_value(&mut self, v: SocketAddr) {
        self.value = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_value<'a>(&'a mut self) -> &'a mut SocketAddr {
    ...
    // Take field
    pub fn take_value(&mut self) -> SocketAddr {
        self.value.take().unwrap_or_else(|| SocketAddr::new())
    }

    pub fn get_value<'a>(&'a self) -> &'a SocketAddr {
        self.value.as_ref().unwrap_or_else(|| SocketAddr::default_instance())
    }
}
...
impl SocketAddr {
    ...
    pub fn default_instance() -> &'static SocketAddr {
        static mut instance: ::protobuf::lazy::Lazy<SocketAddr> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const SocketAddr,
        };
        unsafe {
            instance.get(|| {
                SocketAddr {
...
impl ::protobuf::MessageStatic for SocketAddr {
    fn new() -> SocketAddr {
        SocketAddr::new()
    }

    fn descriptor_static(_: ::std::option::Option<SocketAddr>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<SocketAddr>(
                    "SocketAddr",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::std::cmp::PartialEq for SocketAddr {
...
#[derive(Clone,Default)]
pub struct FuzzyDBMsg {
    // message fields
    field_type: ::std::option::Option<FuzzyDBMsg_Type>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::std::cell::Cell<u32>,
}
...
impl FuzzyDBMsg {
    pub fn new() -> FuzzyDBMsg {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static FuzzyDBMsg {
        static mut instance: ::protobuf::lazy::Lazy<FuzzyDBMsg> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const FuzzyDBMsg,
        };
        unsafe {
            instance.get(|| {
                FuzzyDBMsg {
    ...
    // optional .FuzzyDBMsg.Type type = 1;
    ...
    // Param is passed by value, moved
    pub fn set_field_type(&mut self, v: FuzzyDBMsg_Type) {
        self.field_type = ::std::option::Option::Some(v);
    }

    pub fn get_field_type<'a>(&self) -> FuzzyDBMsg_Type {
        self.field_type.unwrap_or(FuzzyDBMsg_Type::OPEN_WRITE_STREAM)
    }
}

impl ::protobuf::Message for FuzzyDBMsg {
    fn is_initialized(&self) -> bool {
        true
    }
...
impl ::protobuf::MessageStatic for FuzzyDBMsg {
    fn new() -> FuzzyDBMsg {
        FuzzyDBMsg::new()
    }

    fn descriptor_static(_: ::std::option::Option<FuzzyDBMsg>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_enum_accessor(
                    "type",
                    FuzzyDBMsg::has_field_type,
                    FuzzyDBMsg::get_field_type,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<FuzzyDBMsg>(
                    "FuzzyDBMsg",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for FuzzyDBMsg {
    fn clear(&mut self) {
        self.clear_field_type();
        self.unknown_fields.clear();
    }
...
impl ::std::cmp::PartialEq for FuzzyDBMsg {
    fn eq(&self, other: &FuzzyDBMsg) -> bool {
        self.field_type == other.field_type &&
        self.unknown_fields == other.unknown_fields
    }
}

impl ::std::fmt::Debug for FuzzyDBMsg {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
#[derive(Clone,PartialEq,Eq,Debug,Hash)]
pub enum FuzzyDBMsg_Type {
    OPEN_WRITE_STREAM = 0,
}

impl ::protobuf::ProtobufEnum for FuzzyDBMsg_Type {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<FuzzyDBMsg_Type> {
        match value {
            0 => ::std::option::Option::Some(FuzzyDBMsg_Type::OPEN_WRITE_STREAM),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [FuzzyDBMsg_Type] = &[
            FuzzyDBMsg_Type::OPEN_WRITE_STREAM,
        ];
        values
    }

    fn enum_descriptor_static(_: Option<FuzzyDBMsg_Type>) -> &'static ::protobuf::reflect::EnumDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::EnumDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new("FuzzyDBMsg_Type", file_descriptor_proto())
            })
        }
    }
}

impl ::std::marker::Copy for FuzzyDBMsg_Type {
}
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    ,
    ...
    ,
    ...
    ,
];
